...
registerBlockType( 'techer/tc-row-block-1',
    {
        // built-in attributes
        title: 'Techer Row Block 1',
        description: 'Block for showing row of articles without thumbnails',
        icon: 'list-view',
        category: 'layout',
           ...
           //layout
            return (
                <div>
                    ...
                    <h3>Techer Row Block</h3>(No Thumbnail)
