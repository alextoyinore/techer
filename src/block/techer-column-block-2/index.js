...
registerBlockType( 'techer/tc-column-block-2',
    {
        // built-in attributes
        title: 'Techer Column Block 2',
        description: 'Block for showing vertical column of articles with thumbnails',
        icon: 'list-view',
        category: 'layout',
        ...
        edit: ({attributes, setAttributes}) => {
           ...
           //layout
            return (
                <div>
                    <InspectorControls>
                        <PanelBody title='TC Column Block 2 Settings' initialOpen={true}>
                            <PanelRow>
                                <ColorPicker
